...
6. If you are using the job access and resume access modules, you have to
   set the permissions correctly. Visit Administer -> Reports -> Status Report 
   and click on "Rebuild Permissions" under Node Access Permissions.
